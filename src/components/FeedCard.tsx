...
function WorkFeedCard({ item }: { item: WorkFeedItem }) {
  ...
  return (
    <article data-tour="feed-card" className="relative mb-3 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-4 transition duration-150 hover:shadow-[0_2px_20px_rgba(0,0,0,0.05)] active:scale-[0.995]">
