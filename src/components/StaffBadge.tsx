...
export function StaffBadge({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className="inline-block align-text-bottom" role="img" aria-label="Membre de l'équipe vulu">
      <title>Membre de l’équipe vulu</title>
