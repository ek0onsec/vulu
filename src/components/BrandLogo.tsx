...
export function BrandLogo({ brand, size = 20 }: { brand: Brand; size?: number }) {
  if (brand === "discord") {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#5865F2" overflow="visible" aria-hidden>
  ...
  if (brand === "instagram") {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#E1306C" strokeWidth="1.8" overflow="visible" aria-hidden>
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" overflow="visible" aria-hidden>
