...
const user = (id, username, displayName, bio) => ({
  _id: id, id, email: `${username}@vulu.app`, passwordHash: hash, username, displayName,
  bio, avatarUrl: null, activeTabs: ["films"],
...
await db.collection("users").insertMany([
  user("u-demo", "demo", "Toi (démo)", "Compte de démonstration vulu."),
  user("u-alice", "alice", "Alice", "Cinéphile du dimanche, dévoreuse de SF."),
