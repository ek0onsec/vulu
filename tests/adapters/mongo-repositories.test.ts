...
const user = (id: string, over: Partial<User> = {}): User => ({ id, email: `${id}@x.io`, passwordHash: "h",
  ...
  tastes: { filmGenreIds: [1, 2, 3], people: [] }, plus: false, staff: false, private: false, twoFactorEnabled: false, deactivatedAt: null, notificationsSeenAt: null, createdAt: new Date(), ...over });
