...
describe("formatProgress", () => {
  ...
  it("série sans total", () => {
    expect(formatProgress({ progress: { season: 2, episode: 3, tome: null, page: null, watchedEpisodes: null } },
      { type: "tv", episodeCounts: null, pageCount: null })).toBe("S2 E3");
  });
  it("livre tome + page avec total", () => {
    expect(formatProgress({ progress: { season: null, episode: null, tome: 3, page: 120, watchedEpisodes: null } },
